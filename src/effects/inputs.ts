...
export class Input{
    ...
    getAttrValue(){ //returns value only when its not == to options.value
        var v = this.getValue();
    ...
    change(){ //fires when input changes
        this.effect.change();
    }
    toString(){
...
export class EffectInput extends Input{
    ...
    connectionDetachedEvent(dontChange){
...
//MutiSelectInput
export function MutiSelectInput(){
    Input.apply(this,arguments);
