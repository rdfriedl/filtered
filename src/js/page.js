...
import {observable,parseSearch} from './util.js';
import EffectManager, {InputEffect,OutputEffect} from './effectManager.js';
import DataBase from './dataBase.js';
import Editor from './editor.js';

const Effects = EffectManager.instance.effects;
var page = {
		...
		effects: observable([
			{
				title: 'Shadow',
				desc: '',
				effect: Effects.ShadowEffect
			},
			{
				title: 'Stroke',
				desc: '',
				effect: Effects.StrokeEffect
			},
			{
				title: 'Recolor',
				desc: '',
				effect: Effects.RecolorEffect
			},
			{
				title: 'Blur',
				desc: '',
				effect: Effects.GaussianBlurEffect
			},
			{
				title: 'Sepiatone',
				desc: '',
				effect: Effects.SepiatoneEffect
			},
			{
				title: 'GreyScale',
				desc: '',
				effect: Effects.GreyScaleEffect
			},
			{
				title: 'Bump',
				desc: '',
				effect: Effects.BumpEffect
			},
			{
				title: 'HueRotate',
				desc: '',
				effect: Effects.HueRotateEffect
			}
		]),
		baseEffects: observable([
			{
				title: 'Blend',
				desc: '',
				effect: Effects.BlendEffect
			},
			{
				title: 'ColorMatrix',
				desc: '',
				effect: Effects.ColorMatrixEffect
			},
			{
				title: 'ComponentTransfer',
				desc: '',
				effect: Effects.ComponentTransferEffect
			},
			{
				title: 'Composite',
				desc: '',
				effect: Effects.CompositeEffect
			},
			{
				title: 'ConvolveMatrix',
				desc: '',
				effect: Effects.ConvolveMatrixEffect
			},
			{
				title: 'DiffuseLighting',
				desc: '',
				effect: Effects.DiffuseLightingEffect
			},
			{
				title: 'DisplacementMap',
				desc: '',
				effect: Effects.DisplacementMapEffect
			},
			{
				title: 'Flood',
				desc: '',
				effect: Effects.FloodEffect
			},
			{
				title: 'GaussianBlur',
				desc: '',
			...
			},
			{
				title: 'Image',
				desc: '',
				effect: Effects.ImageEffect
			},
			{
				title: 'Merge',
				desc: '',
				effect: Effects.MergeEffect
			},
			{
				title: 'Morphology',
				desc: '',
				effect: Effects.MorphologyEffect
			},
			{
				title: 'Offset',
				desc: '',
				effect: Effects.OffsetEffect
			},
			{
				title: 'SpecularLighting',
				desc: '',
				effect: Effects.SpecularLightingEffect
			},
			// { this is removed because the position editor only support %
			// 	title: 'Tile',
			//  desc: '',
			// 	effect: Effects.TileEffect
			// },
			{
				title: 'Turbulence',
				desc: '',
				effect: Effects.TurbulenceEffect
			},
		]),
	...
	editor: {
		start: function(cb){
			page.inputEffect = Editor.inst.inputEffect;
			page.outputEffect = Editor.inst.outputEffect;
	...
	filters: {
		...
		update: function(){
			...
			return DataBase.inst.db.filters.each(function(data){
		...
		save: {
			name: observable(''),
			save: function(){
				DataBase.inst.db.filters.get(page.filters.loaded()).then(function(data){
					if(data){
						//update it
						DataBase.inst.db.filters.update(page.filters.loaded(),{
		...
		removeFilter: function(confirm){
			DataBase.inst.db.filters.delete(page.filters.removeID()).then(function(){
